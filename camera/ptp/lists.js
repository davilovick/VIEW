...
lists.getMaxEv = function(itemList) {
  ...
  if (itemList[0].ev > itemList[itemList.length - 1].ev) {
    // first is largest
...
lists.getBulbEvFromSeconds = function(seconds) {
  // only accurate to 1/3 stop
...
lists.getSecondsFromEv = function(ev) {
  // only accurate to 1/3 stop
  for (var i = 0; i < lists.bulb.length; i++) {
...
lists.evStats = function(settings, options) {
  ...
  if (settings.aperture && settings.aperture.ev != null) {
    ...
    if (options && options.parameters && options.parameters.indexOf("A") !== -1)
  ...
  if (
    settings.shutter &&
    settings.shutter.ev != null &&
    settings.iso &&
    settings.iso.ev != null
  )
    res.ev = lists.getEv(settings.shutter.ev, av, settings.iso.ev);
...
lists.getEvFromSettings = function(cameraSettings) {
  ...
  var av =
    settings.aperture && settings.aperture.ev != null
      ? settings.aperture.ev
      : lists.fixedApertureEv;
...
lists.apertureAll = [
  ...
  },
  {
    name: "1.4",
    ev: -7,
    values: ["1.4", "f/1.4", "f1.4", "1,4"]
  },
  {
    name: "1.6",
    ev: -6 - 2 / 3,
    values: ["1.6", "f/1.6", "f1.6", "1,6"]
  },
  {
    name: "1.7",
    ev: -6.5,
  ...
  },
  {
    name: "2.5",
    ev: -5 - 1 / 3,
    values: ["2.5", "f/2.5", "f2.5", "2,5"]
  },
  {
    name: "2.8",
    ev: -5,
    values: ["2.8", "f/2.8", "f2.8", "2,8"]
  },
  {
    name: "3.2",
    ev: -4 - 2 / 3,
    values: ["3.2", "f/3.2", "f3.2", "3,2"]
  },
  {
    name: "3.3",
    ev: -4.5,
  ...
  },
  {
    name: "5.6",
    ev: -3,
    values: ["5.6", "f/5.6", "f5.6", "5,6"]
  },
  {
    name: "6.3",
    ev: -2 - 2 / 3,
    values: ["6.3", "f/6.3", "f6.3", "6,3"]
  },
  {
    name: "6.7",
    ev: -2.5,
  ...
  },
  {
    name: "7.1",
    ev: -2 - 1 / 3,
    values: ["7.1", "f/7.1", "f7.1", "7,1"]
  },
  {
    name: "8",
    ev: -2,
    values: ["8", "f/8", "f8", "8.0", "8,0"]
  },
  {
    name: "9",
    ev: -1 - 2 / 3,
    values: ["9", "f/9", "f9", "9.0", "9,0"]
  },
  {
    name: "9.5",
    ev: -1.5,
...
lists.shutterAll = [
  ...
  },
  {
    name: "30s",
    ev: -11,
    values: ["300/10", "30", "30.0000s", '30"']
  },
  {
    name: "25s",
    ev: -10 - 2 / 3,
    values: ["250/10", "25", "25.0000s", '25"']
  },
  {
    name: "24s",
    ev: -10.5,
  ...
  },
  {
    name: "20s",
    ev: -10 - 1 / 3,
    values: ["200/10", "20", "20.0000s", '20"']
  },
  {
    name: "15s",
    ev: -10,
    values: ["150/10", "15", "15.0000s", '15"']
  },
  {
    name: "13s",
    ev: -9 - 2 / 3,
    values: ["130/10", "13", "13.0000s", '13"']
  },
  {
    name: "12s",
    ev: -9.5,
  ...
  },
  {
    name: "10s",
    ev: -9 - 1 / 3,
    values: ["100/10", "10", "10.0000s", '10"']
  },
  {
    name: "8s",
    ev: -9,
    values: ["80/10", "8", "8.0000s", '8"']
  },
  {
    name: "6s",
    ev: -8 - 2 / 3,
  ...
  },
  {
    name: "5s",
    ev: -8 - 1 / 3,
    values: ["50/10", "5", "5.0000s", '5"']
  },
  {
    name: "4s",
    ev: -8,
    values: ["40/10", "4", "4.0000s", '4"']
  },
  {
    name: "3s",
    ev: -7 - 2 / 3,
    values: ["32/10", "3", "3.2", "3.2000s", '3.2"', '3,2"']
  },
  {
    name: "3s",
    ev: -7.5,
  ...
  },
  {
    name: "2.5s",
    ev: -7 - 1 / 3,
    values: ["25/10", "2.5", "2.5000s", '2.5"', '2,5"']
  },
  {
    name: "2s",
    ev: -7,
    values: ["20/10", "2", "2.0000s", '2"']
  },
  {
    name: "1.6s",
    ev: -6 - 2 / 3,
    values: ["16/10", "1.6", "1.6000s", '1.6"', '1,6"']
  },
  {
    name: "1.5s",
    ev: -6.5,
  ...
  },
  {
    name: "1.3s",
    ev: -6 - 1 / 3,
    values: ["13/10", "1.3", "1.3000s", '1.3"', '1,3"']
  },
  {
    name: "1s",
    ev: -6,
    values: ["10/10", "1", "1.0000s", "10/10", '1"']
  },
  {
    name: "0.8s",
    ev: -5 - 2 / 3,
    values: ["8/10", "0.8", "10/13", "0.7692s", '0.8"', '0,8"']
  },
  {
    name: "0.7s",
    ev: -5.5,
  ...
  },
  {
    name: "0.6s",
    ev: -5 - 1 / 3,
    values: ["6/10", "0.625", "0.6", "10/16", "0.6250s", '0.6"', '0,6"']
  },
  {
    name: "1/2",
    ev: -5,
    values: ["5/10", "0.5", "1/2", "0.5000s", '0.5"', '0,5"']
  },
  {
    name: "0.4s",
    ev: -4 - 2 / 3,
    values: ["4/10", "0.4", "10/25", "0.4000s", '0.4"', '0,4"']
  },
  {
    name: "1/3",
    ev: -4.5,
...
while (us < 1000000 * 60 * 10) {
  ...
  for (var thirds = 0; thirds < 3; thirds++) {
    ...
    for (var i = 0; i < lists.shutter.length; i++) {
      if (
        lists.shutter[i].ev != null &&
        Math.ceil(lists.shutter[i].ev * 10) ===
          Math.ceil(-(ev + thirds / 3) * 10)
      ) {
